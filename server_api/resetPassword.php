...
$mail->setFrom('yann.lemat@univ-st-etienne.fr', 'SELFIT CREATOR'); // Personnaliser l'envoyeur
...
$mail->isHTML(true); // Define as HTML
      ...
      $mail->CharSet = 'UTF-8';
      $mail->Subject = 'Oubli de mot de passe pour le site Selfit-Creator';
      //$mail->Body = 'Je pense que ça fonctionne <strong>enfin</strong>.';
      $mail->Body = '
      
      Cliquer ici pour choisir un nouveau mot de passe:
      https://selfit.univ-st-etienne.fr/exos/server_api/forgotPassword.php?email='.$email.'&hash='.$hash.'
