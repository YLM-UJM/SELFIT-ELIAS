...
$mail->setFrom('yann.lemat@univ-st-etienne.fr', 'SELFIT'); // Personnaliser l'envoyeur
...
$mail->CharSet = 'UTF-8';
$mail->Subject = 'SELFIT - Validation de votre email';
...
https://selfit.univ-st-etienne.fr/exos/server_api/verify.php?email='.$email.'&hash='.$hash.'
